...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://us.getconvoy.cloud/api';
    ...
    {
        $report  = 'PHP SDK (Convoy\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 26.3.5' . PHP_EOL;
