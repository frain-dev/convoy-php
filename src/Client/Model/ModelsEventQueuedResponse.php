...
/**
 * ModelsEventQueuedResponse Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsEventQueuedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.EventQueuedResponse';
     ...
     * Sets uid
     *
     * @param string|null $uid UID is the event id.
     *
     * @return self
     */
