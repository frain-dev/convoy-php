...
/**
 * ModelsDynamicEvent Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsDynamicEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.DynamicEvent';
     ...
     * Sets event_types
     *
     * @param string[]|null $event_types A list of event types for the subscription filter config
     *
     * @return self
     */
