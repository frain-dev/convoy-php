...
/**
 * DatastoreSQSPubSubConfig Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatastoreSQSPubSubConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'datastore.SQSPubSubConfig';
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint Optional: for LocalStack testing
     *
     * @return self
     */
