...
/**
 * DatastoreGooglePubSubConfig Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatastoreGooglePubSubConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'datastore.GooglePubSubConfig';
     ...
     *
     * @param string|null $service_account encoding/json marshals []byte as a base64 string on the wire.
     *
     * @return self
     */
