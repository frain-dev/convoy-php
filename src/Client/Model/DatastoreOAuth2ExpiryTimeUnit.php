...
/**
 * DatastoreOAuth2ExpiryTimeUnit Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
...
class DatastoreOAuth2ExpiryTimeUnit
{
     ...
     */
    public const EXPIRY_TIME_UNIT_SECONDS = 'seconds';

    public const EXPIRY_TIME_UNIT_MILLISECONDS = 'milliseconds';

    public const EXPIRY_TIME_UNIT_MINUTES = 'minutes';
