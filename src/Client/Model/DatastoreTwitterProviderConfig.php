...
/**
 * DatastoreTwitterProviderConfig Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatastoreTwitterProviderConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'datastore.TwitterProviderConfig';
    ...
    protected static $setters = [
        'crc_verified_at' => 'setCrcVerifiedAt'
    ];
    ...
    protected static $getters = [
        'crc_verified_at' => 'getCrcVerifiedAt'
    ];
    ...
    {
        $this->setIfExists('crc_verified_at', $data ?? [], null);
    }
    ...
    /**
     * Gets crc_verified_at
     *
     * @return string|null
     */
    public function getCrcVerifiedAt()
    {
        return $this->container['crc_verified_at'];
    }

    /**
     * Sets crc_verified_at
     *
