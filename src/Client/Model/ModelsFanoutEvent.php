...
/**
 * ModelsFanoutEvent Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsFanoutEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.FanoutEvent';
     ...
     * Sets owner_id
     *
     * @param string|null $owner_id Used for fanout, sends this event to all endpoints with this OwnerID.
     *
     * @return self
     */
