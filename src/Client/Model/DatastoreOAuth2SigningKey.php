...
/**
 * DatastoreOAuth2SigningKey Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatastoreOAuth2SigningKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'datastore.OAuth2SigningKey';
     ...
     * Sets d
     *
     * @param string|null $d Private key (EC only)
     *
     * @return self
     */
