...
/**
 * ModelsCreateEventType Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsCreateEventType implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.CreateEventType';
     ...
     * Sets category
     *
     * @param string|null $category Category is a product-specific grouping for the event type
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description is used to describe what the event type does
     *
     * @return self
     */
     ...
     * Sets json_schema
     *
     * @param array<string,mixed>|null $json_schema JSONSchema is the JSON structure of the event type
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is the event type name. E.g., invoice.created
     *
     * @return self
     */
