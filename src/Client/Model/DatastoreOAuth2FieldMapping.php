...
/**
 * DatastoreOAuth2FieldMapping Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatastoreOAuth2FieldMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'datastore.OAuth2FieldMapping';
     ...
     * Sets access_token
     *
     * @param string|null $access_token Field name for access token (e.g., \"accessToken\", \"access_token\", \"token\")
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param string|null $expires_in Field name for expiry time (e.g., \"expiresIn\", \"expires_in\", \"expiresAt\")
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string|null $token_type Field name for token type (e.g., \"tokenType\", \"token_type\")
     *
     * @return self
     */
