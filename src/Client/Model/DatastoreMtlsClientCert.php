...
/**
 * DatastoreMtlsClientCert Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class DatastoreMtlsClientCert implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'datastore.MtlsClientCert';
     ...
     * Sets client_cert
     *
     * @param string|null $client_cert ClientCert is the client certificate PEM string
     *
     * @return self
     */
     ...
     * Sets client_key
     *
     * @param string|null $client_key ClientKey is the client private key PEM string
     *
     * @return self
     */
