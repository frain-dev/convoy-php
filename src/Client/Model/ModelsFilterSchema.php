...
/**
 * ModelsFilterSchema Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsFilterSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.FilterSchema';
     ...
     * Sets header
     *
     * @param mixed|null $header header
     *
     * @return self
     */
