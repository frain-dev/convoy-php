...
/**
 * ModelsTestFilterRequestScopes Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsTestFilterRequestScopes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.TestFilterRequestScopes';
     ...
     * Sets headers
     *
     * @param array<string,mixed>|null $headers Headers accepts either \"headers\" or \"header\" for compatibility with the subscription filter tester.
     *
     * @return self
     */
