 ...
 */
class ModelsIDs implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.IDs';
     ...
     * Sets ids
     *
     * @param string[]|null $ids A list of event delivery IDs to forcefully resend.
     *
     * @return self
     */
