...
/**
 * ModelsFilterConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Convoy\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelsFilterConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'models.FilterConfiguration';
    ...
    protected static $openAPITypes = [
        'event_types' => 'string[]',
        'filter' => '\Convoy\Client\Model\ModelsFS'
    ];
     ...
     * Sets event_types
     *
     * @param string[]|null $event_types List of event types that the subscription should match
     *
     * @return self
     */
     ...
     * Gets filter
     *
     * @return \Convoy\Client\Model\ModelsFS|null
     */
     ...
     * Sets filter
     *
     * @param \Convoy\Client\Model\ModelsFS|null $filter Body & Header filters
     *
     * @return self
     */
